...
?>
		<tr>
			...
			<td>
<?php
	print caNavLink($this->request, caNavIcon($this->request, __CA_NAV_ICON_SEARCH__), 'mmsSetSearch', 'lhmMMS', 'AdminTools', 'CreateSetForValue', ['value_id' => array_pop($va_value_records[$vs_val]), 'table_num' => $vn_table_num, 'element_id' => $t_element->getPrimaryKey()]);
	print "&nbsp; &nbsp;";
	print caNavLink($this->request, caNavIcon($this->request, __CA_NAV_ICON_BATCH_EDIT__), 'mmsSetBatch', 'lhmMMS', 'AdminTools', 'CreateSetForValue', ['value_id' => array_pop($va_value_records[$vs_val]), 'table_num' => $vn_table_num, 'element_id' => $t_element->getPrimaryKey(), 'batch' => 1]);
?>
			</td>
		</tr>
<?php
