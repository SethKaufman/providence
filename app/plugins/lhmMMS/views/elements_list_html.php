		...
		<tr>
			...
			<td>
				<div class="saveDelete">
					<?php print caNavLink($this->request, caNavIcon($this->request, __CA_NAV_ICON_GO__), '', 'lhmMMS', 'AdminTools', 'FieldValsForElement', ['element_id' => $va_element['element_id'], 'table_num' => $va_element['table_num']]); ?>
				</div>
			</td>
		</tr>
<?php
