...
class AdminToolsController extends ActionController {
	...
	public static function getRelativeStats($pa_timestamps) {
		...
		$va_relative_stats_queries = [
			'Objekte' => Datamodel::getTableNum('ca_objects'),
			'Zugänge' => Datamodel::getTableNum('ca_object_lots'),
			'Ausstellungen/Objektgruppen/Konvolute' => Datamodel::getTableNum('ca_occurrences'),
			'Personen/Institutionen/Ethnien' => Datamodel::getTableNum('ca_entities'),
			'Standorte' => Datamodel::getTableNum('ca_storage_locations'),
			'Leihgaben' => Datamodel::getTableNum('ca_loans'),
			'Sets' => Datamodel::getTableNum('ca_sets'),
			'Medien' => Datamodel::getTableNum('ca_object_representations'),
		];
