		...
		public static function initPlugins() {
			...
			foreach($va_plugin_locations as $vs_app_plugin_dir) {
				foreach($va_app_plugin_dirs as $vs_plugin_dir) {
					if(isset(ApplicationPluginManager::$s_application_plugin_instances[$vs_plugin_dir]) && ApplicationPluginManager::$s_application_plugin_instances[$vs_plugin_dir]) { continue; }
